...
|----------|-----------------|-----------------|-------------------|
| **Identify Slow / Stale Jobs** | `yarn application -list -appStates RUNNING | awk '$5 > 7200000'` | Lists running jobs exceeding 2 hours | `# Helps detect jobs running longer than expected, possibly stale` |
