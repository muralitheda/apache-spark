...
| **Optimize Slow Spark Jobs (Multi-node vs Single-node)** | Executor Configuration                     | Tune number of executors, cores, and memory        | `# Too many small executors can slow jobs; align executor size with data volume`     |                                                                       |                                  |                                                                      |                                                                                |
